...
`bryanunitek/UniCORE.Loki` is the **Loki** family member: On-prem-deployment-shape public gift surface. Documentation today; source code at certification.
...
- `bryanunitek/UniCORE.Loki` — public on-prem-deployment-shape gift surface ← **this repo**
- `bryanunitek/UniSaaS.UniCORE.Loki` — public SaaS-deployment-shape gift surface
...
- **Public discussion:** [GitHub Discussions](https://github.com/bryanunitek/UniCORE.Loki/discussions)
