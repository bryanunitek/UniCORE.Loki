...
3. Document the family pattern and upstream relationship in [`README.md`](https://git.unitek-systems.com/UniCORE/UniCORE.Loki/src/branch/main/README.md) (mirror: [GitHub](https://github.com/bryanunitek/UniCORE.Loki/blob/main/README.md)).
4. Document the merge discipline in [`UPSTREAM-MERGE-DISCIPLINE.md`](https://git.unitek-systems.com/UniCORE/UniCORE.Loki/src/branch/main/UPSTREAM-MERGE-DISCIPLINE.md) (mirror: [GitHub](https://github.com/bryanunitek/UniCORE.Loki/blob/main/UPSTREAM-MERGE-DISCIPLINE.md)).
